                        ...
                        <form @submit.prevent="saveAiConfig" class="space-y-4 max-w-2xl">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input v-model="aiForm.model_name" type="text" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="e.g. gpt-4o, gemini-1.5-pro" required />
                                </div>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">API Key</label>
                                <input v-model="aiForm.api_key" type="password" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" :placeholder="isEditing ? 'Leave blank to keep existing key' : 'sk-...'" :required="!isEditing" />
                            </div>
